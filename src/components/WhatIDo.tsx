        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I build scalable, production-ready web applications and backend systems with a
          ...
          >
            ...
            <div className="what-content-in">
              <h3>AI / ML</h3>
              <h4>Machine Learning &amp; Intelligence</h4>
              <p>
                I design intelligent systems using machine learning for prediction, automation,
                and data-driven decision making across real-world domains.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">Model Building</div>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                I architect complete solutions from idea to deployment, including backend logic,
                databases, cloud infrastructure, and scalable API design.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
